---
title: |
 | \vspace{5cm} Ejercicio N°3
subtitle: |
 Diseño de experimentos - FCS3001
...
Mientras tanto la media marginal (MM) describe el nivel de “favorabilidad” hacia los perfiles para todos los niveles de un atributo/característica en particular, ignorando todas las demás. Es decir, la media marginal es un valor promedio para cada nivel, siendo un valor absoluto de preferencia. Es por esta razón que Wimmer et al. [-@wimmer_geopolitical_2025] prefieres las medias marginales (MM) a los efectos de componentes marginales promedio (AMCE), ya que las medias marginales  no dependen de la elección de una categoría de referencia, además de permitir comparar directamente preferencias entre subgrupos de encuestados así como la magnitud entre los países de origen de los inmigrantes y otros atributos. Entre las ventajas de las medias marginales es su fácil interpretación en tanto se hace como probabilidades.Igualmente, la diferencia entre medias marginales de dos grupos es siempre fija en los datos, mientras que en el AMCE está supeditado al centramiento en un punto en los datos (categoría de referencia).

# Pregunta 3

Para el país que le ha sido asignado:

a) Reproduzca los análisis de las Figuras 1 y 2 en Wimmer et al. [-@wimmer_geopolitical_2025]. Puede presentar sus resultados en una tabla de calidad o en figuras.
